...
Your answer here: Peanut, Shortening, Sunflower
...
doughnuts.reg <- lm(sim_tot_fat~fat_type_factor*flour_type_factor,data=doughnuts.factorial) # Complete this line
...
75.167 - 15.167 * (1) - 8.833 * (1) - 3.833 * (1)
...
Your answer here: The red line should be examined. The better it fits to the dotted line the better the linearity is.
...
Your answer here: fishpart_factor2 (reject in first model -> fail to reject in second model)                          
                  fishpart_factor3 (fail to reject in first model -> reject in second model)
